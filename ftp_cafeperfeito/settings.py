"""
Django settings for ftp_cafeperfeito project.
...
ALLOWED_HOSTS = ['www.cafeperfeito.com.br', '127.0.0.1']
...
ROOT_URLCONF = 'ftp_cafeperfeito.urls'
...
WSGI_APPLICATION = 'ftp_cafeperfeito.wsgi.application'
